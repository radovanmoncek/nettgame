package cz.radovanmoncek.nettgame.nettgame.ship.bay.utilities.reflection;
...
public final class ReflectionUtilities {
    ...
    public static Field returnDeclaredFieldReflectively(Object object, String fieldName) throws NoSuchFieldException {
        ...
        Class<?> clazz = object instanceof Class<?> checkedClazz? checkedClazz: object.getClass();

        while(clazz != Object.class && Arrays.stream(clazz.getDeclaredFields()).noneMatch(field -> field.getName().equals(fieldName)))
