package client.game.docker.modules.lobbies.handlers;
                ...
                .withChannelHandler(() -> new LobbyChannelHandler(sampleGameClient) {

                    {
                        ...
                        try {
                            ...
                            LobbyChannelHandlerTest.unicastToServerChannel = getClass().getSuperclass().getMethod("unicastToServerChannel");
