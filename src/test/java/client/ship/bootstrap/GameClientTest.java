...
import client.ship.examples.SampleGameClient;
import server.game.docker.ship.bootstrap.GameServer;
...
public class GameClientTest {
    ...
    void usernameRequestAndReceiveTest() throws InterruptedException {
        assertThrows(IllegalArgumentException.class, () -> sampleGameClient1.getGameClient().getUsernameClientFacade().requestNickname("TestNicknameThatIsWayOverTheLimitOf8Characters"));
        assertThrows(IllegalArgumentException.class, () -> sampleGameClient2.getGameClient().getUsernameClientFacade().requestNickname("TestNicknameThatIsWayOverTheLimitOf8Characters"));
