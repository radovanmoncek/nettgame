...
public final class InstanceContainer {
    ...
    public InstanceContainer withSessionServerFacadeFactory(final Supplier<SessionChannelGroupFacade> sessionServerFacadeFactory) {
    ...
    public InstanceContainer withStateServerFacade(final StateChannelGroupFacade stateChannelGroupFacade) {
        this.stateChannelGroupFacade = stateChannelGroupFacade;
        return this;
    }

    public InstanceContainer withUsernameServerFacade(final PlayerChannelGroupFacade usernameServerFacade) {
        this.playerServerFacade = usernameServerFacade;
        return this;
    }

    public InstanceContainer withLobbyRequestServerFacade(final LobbyChannelGroupFacade lobbyServerFacade) {
        this.lobbyServerFacade = lobbyServerFacade;
        return this;
    }

    public InstanceContainer withChatMessageServerFacade(final ChatMessageChannelGroupFacade chatMessageChannelGroupFacade) {
