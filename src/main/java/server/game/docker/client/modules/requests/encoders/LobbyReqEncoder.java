...
public final class LobbyReqEncoder extends MessageToByteEncoder<LobbyReqPDU> {
    @Override
    public void encode(ChannelHandlerContext channelHandlerContext, LobbyReqPDU in, ByteBuf out) {
