...
public class IndexController {
    ...
    private MyPDUActionMapper actionMapper;
...
//            addLabel(p.decode().get(1), vb_msg);
                ...
                .withActionMapping(MyPDUTypes.JOIN.getID(), p -> {
                    ...
                    sendUnicast(new MyPDU(MyPDUTypes.GAMESTART.getID()));
...
//                    System.out.println("Game started");
                ...
                .withActionMapping(MyPDUTypes.IDREQUEST.getID(), p -> {
...
//                    appendChatMessage("Waiting for other player ..."); todo: server manages
                    ...
                    Platform.runLater(() -> {
                        ...
                        switch(tileType) {
                            case RESOURCENODE -> {
                                ...
                                gameTile.setOnMouseClicked((MouseEvent t) -> sendUnicast(MyPDU.fromPlayerMoveData(clientID, i, j, (byte) 0)));
                            }
                ...
                .withActionMapping(MyPDUTypes.GAMESTART.getID(), p -> appendChatMessage("System", "Game has started"))
                .withActionMapping(MyPDUTypes.GAMEEND.getID(), p -> {
                ...
                .withActionMapping(MyPDUTypes.SERVERTICKUPDATE.getID(), p -> Platform.runLater(() -> {
...
//                    e.printStackTrace();
        ...
        btn_send_chat_msg.setOnAction(e -> {
            if(tf_msg.getText().isBlank() || clientID == null)
                return;
            sendUnicast(new MyPDU(MyPDUTypes.CHATMESSAGE.getID(), clientID.toString(), tf_msg.getText()));
            HBox hBox = new HBox();
...
//        lbl_info.setOnAction(e -> sendUnicast(new MyPDU00Join()));
    ...
    public static void sendUnicast(MyPDU p){
        ...
        for (byte i = 0; i < 11; i++)
            for (byte j = 0; j < 11; j++) {
                ...
                if(j == 5) {
                    ...
                    waterTile.setOnMouseClicked((MouseEvent t) -> sendUnicast(MyPDU.fromPlayerMoveData(clientID, iFin, jFin, (byte) 1)));
