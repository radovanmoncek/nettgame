package cz.radovanmoncek.server.ship.tables;// automatically generated by the FlatBuffers compiler, do not modify
...
public final class Game extends Table {
  ...
  public static final class Vector extends BaseVector {
    ...
    public Game get(int j) {
      return get(new Game(), j);
    }

    public Game get(Game obj, int j) {
